...
@section('description', 'Create a new subscription plan')
            ...
            <div class="pt-6 border-t border-gray-200">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="number" name="max_documents" id="max_documents" value="{{ old('max_documents') }}" min="0"
                               class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent"
                    ...
                    <div>
                        ...
                        <input type="number" name="max_customers" id="max_customers" value="{{ old('max_customers') }}" min="0"
                               class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent"
                               placeholder="Leave empty for unlimited">
            ...
            <div class="pt-6 border-t border-gray-200">
                ...
                <div class="space-y-4">
                    <label class="flex items-center space-x-3 cursor-pointer group">
                        <input type="checkbox" name="can_send_line" value="1" {{ old('can_send_line') ? 'checked' : '' }}
                    ...
                    <label class="flex items-center space-x-3 cursor-pointer group">
                        <input type="checkbox" name="can_customize_template" value="1" {{ old('can_customize_template') ? 'checked' : '' }}
                               class="w-5 h-5 text-purple-600 border-gray-300 rounded focus:ring-purple-500">
                        <div>
                            <div class="font-medium text-gray-900 group-hover:text-purple-600 transition">
