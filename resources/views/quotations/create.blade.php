                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <form method="POST" action="{{ route('quotations.store') }}" id="quotationForm">
                        ...
                        <div class="grid md:grid-cols-2 gap-4 mb-6">
                            ...
                            <div>
                                ...
                                <select id="status" name="status" class="border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm block mt-1 w-full" required>
                                    ...
                                    <option value="accepted" {{ old('status') == 'accepted' ? 'selected' : '' }}>ยอมรับ</option>
                                    <option value="rejected" {{ old('status') == 'rejected' ? 'selected' : '' }}>ปฏิเสธ</option>
                                </select>
                            ...
                            <!-- Valid Until -->
                            <div>
                                <x-input-label for="valid_until" :value="__('วันหมดอายุ *')" />
                                <x-text-input id="valid_until" class="block mt-1 w-full" type="date" name="valid_until" :value="old('valid_until', date('Y-m-d', strtotime('+30 days')))" required />
                        ...
                        <div class="mb-6">
                            ...
                            <textarea id="terms" name="terms" rows="3" class="border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm block mt-1 w-full">{{ old('terms') }}</textarea>
    ...
    <script>
        ...
        function addItem() {
            ...
            row.innerHTML = `
                ...
                <td class="px-3 py-2">
                    <input type="number" name="items[${itemIndex}][discount]" value="0" step="0.01" min="0"
