...
<head>
    ...
    <title>ลงทะเบียน - Invoice SAAS</title>
    ...
    <div class="min-h-screen flex flex-col sm:justify-center items-center pt-6 sm:pt-0 px-4 py-12">
        ...
        <div class="w-full sm:max-w-md glass-effect shadow-2xl rounded-3xl p-8">
            ...
            <div class="text-center mb-8">
                ...
                <p class="text-gray-600">เริ่มต้นจัดการเอกสารธุรกิจของคุณ</p>
            </div>
            ...
            <form method="POST" action="{{ route('register') }}" class="space-y-5">
                ...
                <div class="flex items-start">
                    ...
                    <label for="terms" class="ml-3 text-sm text-gray-600">
                        ฉันยอมรับ
                        <a href="#" class="text-purple-600 hover:text-purple-800 font-medium">เงื่อนไขการใช้งาน</a>
                        และ
                        <a href="#" class="text-purple-600 hover:text-purple-800 font-medium">นโยบายความเป็นส่วนตัว</a>
                    </label>
                </div>
